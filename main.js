...
//   chat popup is opend or closed  at botthom of the icon 
...
function sendIDMsg(){
 ...
 //code
    ...
    var div = document.createElement("div");
    div.id="botqueries",
    div.innerHTML =`<div id="bot1"><a id="a1" href ="http://rguktcet.in/images/RGUKT-CET2020-ImportantDates.pdf" target="_blank">click here to get Important Dates List</a></div>`;
    chatArea.appendChild(div);
    chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
  },1500);
},1500);
...
function sendCWMsg(){
 ...
 //code
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1"><a id="a1" href ="https://rguktn.ac.in/" target="_blank">RGUKT NUZVID WEBSITE</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
},1500);
}
...
function post_graduate()
{
 ...
 //code
  ...
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<div id="bot1"><a id="a1" href ="https://admissions.rguktn.ac.in/" target="_blank">Complete Details of Masters Program</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
},1500);
},1500);
...
function sendARMsg(){
  ...
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<div id="bot1"><a id="a1" href ="https://rguktn.ac.in/academics/academic-regulations/Academic-Regulations-2019.pdf" target="_blank">Academic Regulations</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
},1500);
},1500);
...
function sendACMsg(){
 ...
 //code
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1">The schedule of events occurring in the academic year including term times, examination dates, etc.</div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
...
function sendEatCMsg(){
 ...
 //code
  ...
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<div id="bot1"><a id="a1" href ="https://www.quora.com/What-is-your-review-of-IIIT-Nuzvid#:~:text=IIIT%20Nuzvid%20is%20a%20very,laptops%20and%20internet%20for%20studying.&text=IIIT%20Nuzvid%20offers%206%20years,after%20completion%20of%20their%20SSC%20." target="_blank">Education at RGUKT(N) - Quora</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
},1500);
},1500);
...
function sendACLMsg(){
 ...
 //codechatArea.appendChild(botDiv);
  ...
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1">${admValue}<a id="a1" href ="https://rguktn.ac.in/about/CampusLife/" target = _blank>Click here to know more...</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
...
function sendESMsg(){
  ...
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1"><a id="a1" href ="https://rguktn.ac.in/gallery/" target = _blank>Click here to know more...</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
...
function sendAandAMsg(){
 ...
 //code
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1">RGUKT Nuzvid students prove themseleves in many<br> competitions.<br>Click the below link to know about the achievements<br> of RGUKT.<br><a id="a1" href ="https://rguktn.ac.in/about/achievements/" target="_blank">Achievements & Awards</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
},1500);
}
...
function events(){
 ...
 //code
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1">News, Events & Activities of RGUKT <br><a id="a1" href ="https://rguktn.ac.in/events/" target="_blank">Click Here....</a></div>`;
  chatArea.appendChild(div);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
},1500);
}
...
function address(){
 ...
 //code
  var div = document.createElement("div");
  div.id="botqueries",
  div.innerHTML =`<br><div id="bot1"><a id="a1" href ="https://rguktn.ac.in/contactus/" target="_blank">Address and Directons</a></div>
                  <div><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3819.712354818649!2d80.81862701470244!3d16.790980588438522!2m3
                  !1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3675e53fa3b4fb%3A0xfd1e193c90e4643!2sRajiv%20Gandhi%20University%20of%20Knowledge%2
                  0and%20Technology%20%2C%20Nuzvid!5e0!3m2!1sen!2sin!4v1621344509970!5m2!1sen!2sin" width="200" height="200" style="border:1px solid blue;"
...
function chancellorMsg()
{
  ...
  var botDiv = document.createElement("div");
  //botDiv.id = "botqueries";
  botDiv.innerHTML = `<div><a id="aa1" href ="https://rguktn.ac.in/administration/chancellor/" target="_blank">
  <img src ="kc-reddy.jpg" width="250px" height ="250px" id="aa1"></a></div>`;
  chatArea.appendChild(botDiv);
  chatArea.scrollTop = chatArea.scrollHeight - chatArea.clientHeight;
  botTyping();
   setTimeout(function(){ 
